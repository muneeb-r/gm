  ...
  return (
    <nav className='bg-white h-[60px] z-50 border-b border-gray-200 px-4 py-1 flex justify-between items-center sticky top-0'>
      <div className="flex items-center space-x-1">
        <div onClick={() => setTogglesidebarondesktop(prev => !prev)} className="flex text-black bg-gray-100 p-1 rounded-lg shadow cursor-pointer hover:bg-opacity-60 active:bg-opacity-40">
      ...
      <div className="flex relative">
        <div onClick={()=> setShowemployeemenu(prev=> !prev)} className="flex  items-center space-x-3 cursor-pointer hover:bg-gray-100 border border-gray-200 active:bg-opacity-10 p-1 pr-2 rounded-3xl">
