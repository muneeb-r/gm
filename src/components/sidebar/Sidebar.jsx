                    ...
                    <div className="flex pr-2 mt-5 flex-col space-y-3">
                        {links.map((link, index) => (
                            <Link href={link.link} key={index}>
                                <div className={`flex relative rounded-r-full gap-3 px-3 py-3 hover:bg-orange-100 transition-all duration-200 active:bg-orange-300 group cursor-pointer ${currentPage === link.title && 'bg-orange-100 c-shadow'}`}>
                                    ...
                                    <div className={`text-black transition-all duration-300 ${togglesidebarondesktop?'opacity-0':'opacity-100'} ${currentPage === link.title && 'text-orange-600'}`}>{link.title}</div>
                                </div>
                            </Link>
                        ))}
                    </div>
