...
export default function Login() {
    ...
    const { decodeEmployee, setEmployee, employee } = useContext(AuthContext)
        ...
        if (email && password && campus) {
            axios.post('/api/employee/auth', {
                ...
                decodeEmployee(res.data.token).then(r => {
                    ...
                    }else if(r.employee.isAdmin){
                        localStorage.setItem('campus', campus)
                    }else{
                        return toast.error('Empoyee should have either campus or be admin.')
                    }
            ...
            <main className='flex justify-center items-center h-screen backdrop-blur-sm bg-gray-50'>
                <div className='flex h-[80vh] flex-row shadow-lg rounded-xl overflow-hidden z-50 border border-gray-100'>
                    <div className="relative hidden md:flex">
                        ...
                        <img className='w-14 h-14 absolute top-5 left-5' src="/favicon.png" alt="" />
                    </div>
